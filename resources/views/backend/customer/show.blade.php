                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Company Name </th><td> {{ $customer->company_name }} </td></tr><tr><th> Customer Name </th><td> {{ $customer->customer_name }} </td></tr><tr><th> Location </th><td> {{ $customer->location }} </td></tr>
                                </tbody>
                            </table>
                        </div>
